...
set(Cone,'AmbientStrength',1,'FaceColor',cyl_color,'FaceLighting','gouraud','FaceAlpha',0.5);%,'EdgeColor','none')
if closed==1
    set([EndPlate1 EndPlate2],'AmbientStrength',1,'FaceColor',cyl_color,'FaceLighting','gouraud','FaceAlpha',0.5);%,'EdgeColor','none')
else
    EndPlate1=[];
    EndPlate2=[];
end
